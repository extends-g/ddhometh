...
namespace Dhome\Bundle\WebBundle\Pagerfanta\View\Template;
...
class TwitterBootstrap4Template extends Template
{
    ...
    private function linkLi($class, $href, $text)
    {
        ...
        return sprintf('<li%s><a class="page-link" style="border-radius: 0;" href="%s">%s</a></li>', $liClass, $href, $text);
    }
    ...
    private function spanLi($class, $text)
    {
        ...
        return sprintf('<li%s><a href="#" class="page-link" style="border-radius: 0;"><span>%s</span></a></li>', $liClass, $text);
    }
}
